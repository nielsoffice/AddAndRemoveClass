...
```JS
    ...
    HPHowItWorks.prototype.disableActiveAccordion = function(cID, conID) {
		
		let ifTrue = jQuery('#' + cID).parent().addClass('HP-disable-active'); // addClass on it can be attribute if you wish!	
